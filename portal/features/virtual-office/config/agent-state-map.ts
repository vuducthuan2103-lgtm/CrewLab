...
export const AGENT_STATE_MAP: Record<AgentVisualState, AgentStatePresentation> = {
  idle: {
    ...
    labelEn: 'idle', dotColor: '#71717a', allowLargeBubble: false, attentionPriority: 99, requiresCEO: false, emoji: '⚪',
  },
  working: {
    state: 'working', labelVi: 'Đang làm', descVi: 'Đang xử lý nhiệm vụ.',
    labelEn: 'working', dotColor: '#10b981', allowLargeBubble: false, attentionPriority: 80, requiresCEO: false, emoji: '🟢',
  },
  waiting_human: {
    state: 'waiting_human', labelVi: 'Chờ bạn', descVi: 'Cần CEO xem và hành động.',
    labelEn: 'waiting_human', dotColor: '#f59e0b', allowLargeBubble: true, attentionPriority: 1, requiresCEO: true, emoji: '🟡',
  },
  reviewing: {
    state: 'reviewing', labelVi: 'Đang kiểm tra', descVi: 'Đang thẩm định và kiểm tra chất lượng.',
    labelEn: 'reviewing', dotColor: '#818cf8', allowLargeBubble: false, attentionPriority: 70, requiresCEO: false, emoji: '🔵',
  },
  reworking: {
    state: 'reworking', labelVi: 'Đang làm lại', descVi: 'Đang chỉnh sửa lại theo phản hồi.',
    labelEn: 'reworking', dotColor: '#fb923c', allowLargeBubble: false, attentionPriority: 60, requiresCEO: false, emoji: '🟠',
  },
  success: {
    state: 'success', labelVi: 'Hoàn thành', descVi: 'Đã hoàn tất nhiệm vụ thành công.',
    labelEn: 'success', dotColor: '#D4FF00', allowLargeBubble: true, attentionPriority: 50, requiresCEO: false, emoji: '✅',
  },
  error: {
    state: 'error', labelVi: 'Có lỗi', descVi: 'Gặp sự cố, cần CEO kiểm tra.',
    labelEn: 'error', dotColor: '#ef4444', allowLargeBubble: true, attentionPriority: 2, requiresCEO: true, emoji: '🔴',
  },
  rejected: {
    state: 'rejected', labelVi: 'Đã từ chối', descVi: 'Nhiệm vụ bị từ chối, đang chờ xử lý.',
    labelEn: 'rejected', dotColor: '#f87171', allowLargeBubble: true, attentionPriority: 10, requiresCEO: true, emoji: '⛔',
  },
};
