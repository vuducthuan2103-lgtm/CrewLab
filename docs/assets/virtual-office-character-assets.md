...
| B03 | v11 stylized seated content-planner candidate | Blender official stylized male base plus MakeHuman system-assets `short03` hair, same CC0 sources recorded above | Blender asset contributors; MakeHuman Community system-asset authors | CC0 | Yes; modification and embedded GLB distribution permitted | None required | Cream polo silhouette, navy trousers, white shoes, custom 27-bone seated rig, digit bones, deterministic eye details, workstation anchors, eight authored actions, Meshopt compression | `portal/public/virtual-office/characters/v11/b03.glb` | 27 bones; 9 anchors; 8 actions | 1,475,676 B |
| D01 | v11 stylized seated copywriter candidate | Blender official stylized female base, same CC0 source recorded above | Blender asset contributors | CC0 | Yes; modification and embedded GLB distribution permitted | None required | Rust blouse, cream trousers, long dark hair silhouette, deterministic eye/brow details, custom 27-bone seated rig, digit bones, workstation anchors, eight authored actions, Meshopt compression | `portal/public/virtual-office/characters/v11/d01.glb` | 27 bones; 9 anchors; 8 actions | 1,837,272 B |
| D02 | v11 stylized seated visual-designer candidate | Blender official stylized female base, same CC0 source recorded above | Blender asset contributors | CC0 | Yes; modification and embedded GLB distribution permitted | None required | Cobalt suit, skinned white inner layer, high ponytail with head cap, deterministic eye/brow details, custom 27-bone seated rig, digit bones, workstation anchors, eight authored actions, Meshopt compression | `portal/public/virtual-office/characters/v11/d02.glb` | 27 bones; 9 anchors; 8 actions | 1,844,140 B |
| E01 | v11 stylized seated evaluator candidate | Blender official stylized male base plus MakeHuman system-assets `short03` hair, same CC0 sources recorded above | Blender asset contributors; MakeHuman Community system-asset authors | CC0 | Yes; modification and embedded GLB distribution permitted | None required | White shirt, skinned navy vest and trousers, brown dress shoes, custom 27-bone seated rig, digit bones, workstation anchors, eight authored actions, Meshopt compression | `portal/public/virtual-office/characters/v11/e01.glb` | 27 bones; 9 anchors; 8 actions | 1,493,212 B |
...
B03 measured seated QA: butt-to-horizontal-cushion delta `-0.001 mm` and foot-to-floor delta `+1.682 mm`. Blender round-trip import preserved one armature, 27 bones, 16 meshes, all eight action names and all nine anchors. Eight action midpoints retained the seat and desk contacts.

D01 measured seated QA: butt-to-horizontal-cushion delta below `0.001 mm` and foot-to-floor delta `-2.012 mm`. Blender round-trip import preserved one armature, 27 bones, 17 meshes, all eight action names and all nine anchors. Eight action midpoints retained seat/desk contact with the long-hair volumes following the head.

D02 measured seated QA: butt-to-horizontal-cushion delta below `0.001 mm` and foot-to-floor delta `-2.012 mm`. Blender round-trip import preserved one armature, 27 bones, 18 meshes, all eight action names and all nine anchors. Eight action midpoints retained contact; the ponytail and head cap follow the authored head motion without exposing the scalp.

E01 measured seated QA: butt-to-horizontal-cushion delta `-0.001 mm` and foot-to-floor delta `+1.682 mm`. Blender round-trip import preserved one armature, 27 bones, 16 meshes, all eight action names and all nine anchors. Eight action midpoints retained seat/desk contact and the fitted vest follows torso motion.
